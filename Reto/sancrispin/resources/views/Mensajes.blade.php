...
@section('contenido')
    ...
    <section id="mensajes">
            ...
            <ul>
                @foreach ($mensajes as $mensaje)
                    <li>
                        ...
                        {{ $mensaje->mensaje }}<br>
                        <strong>Stock:</strong> {{ $mensaje->stock }}<br>
        ...
        <form action="{{ route('productos.guardar.rapido') }}" method="POST">
            ...
            <div>
                <label for="stock-cliente">Stock / Cupos:</label><br>
                <input type="number" name="stock-cliente" id="stock-cliente" value="{{ old('stock-cliente', 0) }}" min="0">
                @error('stock-cliente')
